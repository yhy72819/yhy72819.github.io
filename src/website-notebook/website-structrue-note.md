...
2. 修改口号:tagline:你可以在这里放置你的口号和标语
3. 修改背景图片（参考网站[](https://haowallpaper.com/homeView)）代码如下
...
4. 注意事项
    ...
    2. 在网站的所有配置当中，“/”开始就代表文件夹“public”(但如果是通过链接形式进入的话，/则表示链接，与public无关，要从src以下开始输入路径，src不用，但巧合的是，这两个方式的搜索途径是一样的，容易混淆）
    3. VScode忘打message如何拯救
        1. 方法一：在弹出的界面中，输入message（不要在井号后输入，井号后文字是注释，无实际意义）-->Command+S保存后-->关掉，再次点击按钮进行推送
        2. 方法二：直接关掉弹出的文件界面，并重新操作提交流程

    ![image.png](./website-structrue-note.assets/1753709694330-0a3977df-457c-41a0-bb07-55836dce8f83.png)
...
![image.png](./website-structrue-note.assets/1753710376982-7fa3b972-da65-49cd-afc9-5549f68d60e6.png)
...
注意：以图片中二维码为链接的直接用图片部署形式填写入双引号内,同时，任何图片部署入public都可按指定路径在原域名后输入作为链接访问![image.png](./website-structrue-note.assets/1753796393591-4725b81f-de87-471a-ad29-5682251f77ad.png)

![image.png](./website-structrue-note.assets/1753797872631-4df4be95-572a-40c0-8060-a001f7094ec5.png)

### 11.5 菜单栏修改

![image.png](./website-structrue-note.assets/1753883078743-b53acc8f-d01a-4a16-b46c-b16392affd79.png)

![image.png](./website-structrue-note.assets/1753883115528-863b984c-cc42-4265-b1b2-e4634d956a1a.png)
...
![image.png](./website-structrue-note.assets/1753883407563-6f17a239-b998-4052-906f-78814ef26f50.png)

另：有关文章变pdf的方法，可右键点击打印

![image.png](./website-structrue-note.assets/1753883536159-b6d4cc20-87c1-4540-baaf-fbfca88fd506-20250813205544227.png)

![image.png](./website-structrue-note.assets/1753883645836-0dfa2801-ba80-43aa-8140-8714580d7eee.png)

### 11.6 sidebar的妙法

对于sidebar，我们无需如navbar一样一个一个输，可用如下图格式直接令其自动生成（structure即为自动生成的指令）

![image.png](./website-structrue-note.assets/1753884166418-6fec1b65-7fbc-43c7-a74d-8fe84c90bff1.png)
...
4. 点击左上角创建应用并起名，使用免费的开发版（详情请见a链接中的教程）

![image.png](./website-structrue-note.assets/1753968778336-98d6fb84-4be9-4111-993a-4584156aff12.png)

5. 注册后点击应用，选择设置中的应用凭证

![image.png](./website-structrue-note.assets/1753969193272-d4e2a52e-0191-477a-a77f-c1219d55b5bc.png)
...
1. 利用上述工具进入Vercel
2. 进入后用github快速绑定Vercel

![image.png](./website-structrue-note.assets/1753969788357-379c73f8-0a27-44c8-b2a1-4c0e339927d6.png)

3. 绑定成功后

![image.png](./website-structrue-note.assets/1753969822348-3d064e94-d088-4504-84d3-d98b80ebe9f7.png)

4. 点击continue to dashboard即可开始

5. 点击顶部的 `Settings` - `Environment Variables` 进入环境变量配置页，并配置三个环境变量 `LEAN_ID`, `LEAN_KEY` 和 `LEAN_MASTER_KEY` 。它们的值分别对应上一步在 LeanCloud 中获得的 `APP ID`, `APP KEY`, `Master Key`。![img](./website-structrue-note.assets/1753970527870-f5a528d8-1d7b-4d22-9e18-31ed5fe7ffc0.png)

6. 完成后右下角会弹出验证框，全部点进行验证即可开始验证

7. 检查是否成功点击上方deployment观看，ready即为成功

    ![image.png](./website-structrue-note.assets/1753970722742-1372b059-7947-4e9d-a875-50adbcf7f11d.png)

8. 注意：当我们进入自己的Vercel账号时，为本体账号，应进入自己的项目中进行配置

    ![image.png](./website-structrue-note.assets/1754229210796-d20cc394-a44e-4431-b526-4c25e64f8141.png)

    进入后再进入settings才能正常部署，而直接在个人页面进入Settings则无法正常部署

    1. 如果想要更活泼的评论，在输入comment: true的附近添加一行reaction：true
    ...
    ![image.png](./website-structrue-note.assets/1754229905408-605c7d54-0020-4fee-9fc5-a15d1be75bd2.png)
    ...
    ![image.png](./website-structrue-note.assets/1754143543610-effa8580-504b-46d8-85af-f8099278d625.png)

    ![image.png](./website-structrue-note.assets/1754143575250-00201050-b3ee-41d0-b5ac-c411c2d5fb85.png)
    ...
    ![](./website-structrue-note.assets/1754227062830-a1908ac8-ea14-4978-89c4-58e1dea1cb2e.png)
    ...
    ![img](./website-structrue-note.assets/open-graph-general.png)
    ...
    ![image.png](./website-structrue-note.assets/1754315051548-59192832-c188-4f12-a5d8-43e2a9197307.png)

    

    Pro是付费款，选择不付费的，并点击

    ![image.png](./website-structrue-note.assets/1754315140384-28e34ee2-621f-4bc8-a60f-bf9bd9e8f47c.png)

    于Vscode的icon一行（分别在navbar和readme中）粘贴，并删掉非如上图绿色部分内容，如：

    ![image.png](./website-structrue-note.assets/1754315267192-777dae03-d107-4fc5-9c35-3200c11a092a.png)
    ...
    ![image.png](./website-structrue-note.assets/1754399516070-6496e30f-ab7c-44a7-8d61-c38a094efb86.png)
    ...
    2. 在Vscode中部署：找到theme.ts中的plugins，在此后插入此段代码

    ![image.png](./website-structrue-note.assets/1754400404072-b3bf238f-3a68-4146-a19c-8bfe607087bb.png)

    

    其中maxSuggestions为最大搜索提示量，如下图所示

    ![image.png](./website-structrue-note.assets/1754400518416-746c33ed-52cf-45e2-9ae6-31abb7b42d0f.png)
    ...
    ![image.png](./website-structrue-note.assets/1754486651985-321f5c60-01d2-4f56-91da-4ae844820b7d.png)
    ...
    3. src下可以新建任何文件夹，随意命名（推荐使用英文且不带空格，如想要间隔使用："-")
        ...
        1. 推荐英文原因：所有文件夹都将会生成链接，如用中文，使用中会导致链接问题

        ![image.png](./website-structrue-note.assets/1754487853441-e9e5d909-e9f0-4ef7-9b22-c6a7f033ea20.png)
    ...
    [](https://autotime.bornforthis.cn/vuepress-front-matter)
